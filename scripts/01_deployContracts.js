...
async function main() {
  ...
  saveAddress(weth,"weth")
  saveAddress(factory,"factory")
  saveAddress(swapRouter,"swapRouter")
  saveAddress(nftDescriptor,"nftDescriptor")
  saveAddress(nonfungibleTokenPositionDescriptor,"nonfungibleTokenPositionDescriptor")
  saveAddress(nonfungiblePositionManager,"nonfungiblePositionManager")
}
